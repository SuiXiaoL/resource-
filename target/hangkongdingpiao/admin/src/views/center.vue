  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='yonghu'"  label='常去城市' prop="changquchenggshiName">
               <el-input v-model="ruleForm.changquchenggshiName"  placeholder='常去城市' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='yonghu'"  label='常选最低价格' prop="zuidijieshou">
               <el-input v-model="ruleForm.zuidijieshou"  placeholder='常选最低价格' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='yonghu'"  label='常选最高价格' prop="zuigaojiage">
               <el-input v-model="ruleForm.zuigaojiage"  placeholder='常选最高价格' clearable></el-input>
           </el-form-item>
         </el-col>
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.changquchenggshiName)&& 'yonghu'==this.flag){
                             this.$message.error('常去城市不能为空');
                             return
                         }

                         if((!this.ruleForm.zuidijieshou)&& 'yonghu'==this.flag){
                             this.$message.error('常选最低价格不能为空');
                             return
                         }

                         if((!this.ruleForm.zuigaojiage)&& 'yonghu'==this.flag){
                             this.$message.error('常选最高价格不能为空');
                             return
                         }
