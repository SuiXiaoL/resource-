    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="常去城市" prop="changquchenggshiName">
                       <el-input v-model="ruleForm.changquchenggshiName"
                                 placeholder="常去城市" clearable  :readonly="ro.changquchenggshiName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="常去城市" prop="changquchenggshiName">
                           <el-input v-model="ruleForm.changquchenggshiName"
                                     placeholder="常去城市" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="常选最低价格" prop="zuidijieshou">
                       <el-input v-model="ruleForm.zuidijieshou"
                                 placeholder="常选最低价格" clearable  :readonly="ro.zuidijieshou"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="常选最低价格" prop="zuidijieshou">
                           <el-input v-model="ruleForm.zuidijieshou"
                                     placeholder="常选最低价格" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="常选最高价格" prop="zuigaojiage">
                       <el-input v-model="ruleForm.zuigaojiage"
                                 placeholder="常选最高价格" clearable  :readonly="ro.zuigaojiage"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="常选最高价格" prop="zuigaojiage">
                           <el-input v-model="ruleForm.zuigaojiage"
                                     placeholder="常选最高价格" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   changquchenggshiName: [
                              { required: true, message: '常去城市不能为空', trigger: 'blur' },
                          ],
                   zuidijieshou: [
                              { required: true, message: '常选最低价格不能为空', trigger: 'blur' },
                   ...
                   zuigaojiage: [
                              { required: true, message: '常选最高价格不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]{0,6}(\.[0-9]{1,2})?$/,
                                  message: '只允许输入整数6位,小数2位的数字',
                                  trigger: 'blur'
                              }
