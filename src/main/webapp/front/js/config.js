...
var centerMenu = [
    ...
    ,{
        name: '航班收藏',
        url: '../hangbanCollection/list.html'
    }
    ,{
        name: '航班订单',
        url: '../hangbanOrder/list.html'
    }
...
var adminurl =  "http://localhost:8080/hangkongdingpiao/admin/dist/index.html#/login";
