...
public class HangbanCollectionView extends HangbanCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String hangbanCollectionValue;
	...
	public HangbanCollectionView() {

	}

	public HangbanCollectionView(HangbanCollectionEntity hangbanCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, hangbanCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getHangbanCollectionValue() {
				return hangbanCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setHangbanCollectionValue(String hangbanCollectionValue) {
				this.hangbanCollectionValue = hangbanCollectionValue;
			}
