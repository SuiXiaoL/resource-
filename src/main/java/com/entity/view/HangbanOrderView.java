...
public class HangbanOrderView extends HangbanOrderEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 订单类型的值
		*/
		private String hangbanOrderValue;
		/**
		* 支付类型的值
		*/
		private String hangbanOrderPaymentValue;
	...
	public HangbanOrderView() {

	}

	public HangbanOrderView(HangbanOrderEntity hangbanOrderEntity) {
		try {
			BeanUtils.copyProperties(this, hangbanOrderEntity);
			...
			* 获取： 订单类型的值
			*/
			public String getHangbanOrderValue() {
				return hangbanOrderValue;
			}
			/**
			* 设置： 订单类型的值
			*/
			public void setHangbanOrderValue(String hangbanOrderValue) {
				this.hangbanOrderValue = hangbanOrderValue;
			}
			/**
			* 获取： 支付类型的值
			*/
			public String getHangbanOrderPaymentValue() {
				return hangbanOrderPaymentValue;
			}
			/**
			* 设置： 支付类型的值
			*/
			public void setHangbanOrderPaymentValue(String hangbanOrderPaymentValue) {
				this.hangbanOrderPaymentValue = hangbanOrderPaymentValue;
			}
