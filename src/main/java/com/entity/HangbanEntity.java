...
public class HangbanEntity<T> implements Serializable {
    ...
    public String toString() {
        return "Hangban{" +
            ...
            ", zaikeNumber=" + zaikeNumber +
            ", chufashijian=" + chufashijian +
            ", chufadiName=" + chufadiName +
            ", mudidiName=" + mudidiName +
            ", hangbanOldMoney=" + hangbanOldMoney +
            ", hangbanNewMoney=" + hangbanNewMoney +
            ", hangbanContent=" + hangbanContent +
            ", hangbanClicknum=" + hangbanClicknum +
