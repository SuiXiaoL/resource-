...
public class YonghuEntity<T> implements Serializable {
     ...
     * 常去城市
     */
    @TableField(value = "changquchenggshi_name")
    ...
    public String toString() {
        return "Yonghu{" +
            ...
            ", changquchenggshiName=" + changquchenggshiName +
            ", zuidijieshou=" + zuidijieshou +
            ", zuigaojiage=" + zuigaojiage +
            ", sexTypes=" + sexTypes +
