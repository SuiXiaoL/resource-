...
//                            yonghuEntity.setChangquchenggshiName(data.get(0));                    //常去城市 要改的
//                            yonghuEntity.setZuidijieshou(data.get(0));                    //常选最低价格 要改的
//                            yonghuEntity.setZuigaojiage(data.get(0));                    //常选最高价格 要改的
